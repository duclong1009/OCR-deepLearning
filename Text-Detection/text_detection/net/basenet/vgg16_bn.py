    ...
    def __init__(self, pretrained=None, freeze=False):
        ...
        if pretrained:
            vgg_pretrained_features.load_state_dict(
                copyStateDict(torch.load(pretrained)))
        ...
        self.slice5 = torch.nn.Sequential(
            ...
            nn.Conv2d(512, 1024, kernel_size=(3, 3), padding=6, dilation=6),
        ...
        init_weights(self.slice5.modules())  # no pretrained pretrained for fc6 and fc7
